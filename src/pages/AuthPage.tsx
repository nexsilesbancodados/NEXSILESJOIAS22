                          ...
                          {!codigoValidado?.valido && (
                            <Alert className="bg-amber-50 dark:bg-amber-950/30 border-amber-200 dark:border-amber-700/50">
                              ...
                              <AlertDescription className="text-xs text-amber-700 dark:text-amber-300">
                                Não tem código? <button type="button" onClick={() => window.open('https://nexsiles.com.br', '_blank')} className="font-semibold underline hover:no-underline">Adquira um plano</button> para receber seu código de acesso.
                              </AlertDescription>
                            </Alert>
                          )}
