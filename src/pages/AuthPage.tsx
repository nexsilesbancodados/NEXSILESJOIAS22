                          ...
                          {!codigoValidado?.valido && (
                            <Alert className="bg-amber-50 dark:bg-amber-950/30 border-amber-200 dark:border-amber-700/50">
                              ...
                              <AlertDescription className="text-xs text-amber-700 dark:text-amber-300">
                                Não tem código? <a href="https://www.nexsiles.com.br/" target="_blank" rel="noopener noreferrer" className="font-semibold underline hover:no-underline">Adquira um plano</a> para receber seu código de acesso.
                              </AlertDescription>
                            </Alert>
                          )}
