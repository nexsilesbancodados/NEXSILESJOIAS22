...
const FEATURES = [
  ...
  { icon: Package, title: 'Gestão de Estoque', desc: 'Controle do inventário com alertas de reposição, histórico de preços e etiquetas.' },
  ...
  { icon: MessageSquare, title: 'WhatsApp Integrado', desc: 'Envie catálogos, cobranças e notificações via WhatsApp.' },
  { icon: TrendingUp, title: 'Relatórios Avançados', desc: 'Relatórios de lucratividade, desempenho de vendas, ranking de revendedoras e mais.' },
  { icon: Bot, title: 'Assistente IA', desc: 'Chatbot que auxilia no atendimento aos clientes, sugere produtos e ajuda nas vendas.' },
  { icon: Store, title: 'Loja Virtual', desc: 'E-commerce com checkout PIX/Cartão/Boleto, carrinho, cupons e cálculo de frete.' },
  { icon: Shield, title: 'Segurança Multi-tenant', desc: 'Cada empresa tem seus dados isolados. Funcionários com permissões granulares.' },
];
...
const PLANOS = [
  ...
  },
  {
    ...
    icon: Bot,
    cor: 'hsl(var(--warning))',
    recursos: ['Tudo do plano Prata', 'Assistente IA WhatsApp', 'Chatbot integrado', 'Respostas automáticas', 'Sugestões de vendas por IA', 'Análise de estoque', 'Atendimento automatizado', 'Relatórios de IA'],
  },
  {
...
const TESTIMONIALS = [
  { name: 'Carla M.', role: 'Dona de loja de semijoias', text: 'O Nexsiles facilitou muito minha gestão. Antes eu perdia horas no controle manual, agora o sistema organiza tudo para mim.' },
  { name: 'Fernanda S.', role: 'Revendedora', text: 'O portal da revendedora é muito prático. Consigo ver minhas peças, vendas e comissões em tempo real.' },
  { name: 'Juliana R.', role: 'E-commerce de joias', text: 'A automação no WhatsApp me ajuda a atender clientes fora do horário comercial. Senti diferença nas vendas desde que comecei a usar.' },
];
    ...
    <div className="min-h-screen text-white overflow-x-hidden relative">
      ...
      <nav className="fixed top-0 left-0 right-0 z-50 backdrop-blur-xl bg-[hsl(224,30%,8%)]/80 border-b border-white/5">
        ...
        {mobileMenuOpen && (
          <div className="md:hidden bg-[hsl(224,30%,10%)] border-t border-white/5 px-4 py-4 space-y-3">
            ...
            <Button className="w-full bg-gradient-to-r from-purple-600 to-pink-600 text-white" onClick={() => navigate('/auth')}>Experimente Grátis</Button>
          </div>
        )}
      </nav>
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <motion.div initial="hidden" animate="visible" variants={fadeUp} custom={0}>
            <Badge className="mb-6 bg-purple-500/20 text-purple-300 border-purple-500/30 px-4 py-1.5 text-sm">
              <Sparkles className="w-3.5 h-3.5 mr-1.5" /> Plataforma de Gestão para Semijoias
            </Badge>
          </motion.div>
          <motion.h1 initial="hidden" animate="visible" variants={fadeUp} custom={1}
            className="text-4xl sm:text-5xl lg:text-7xl font-extrabold leading-tight mb-6">
            Organize e gerencie seu negócio de{' '}
          ...
          <motion.p initial="hidden" animate="visible" variants={fadeUp} custom={2}
            ...
            Uma plataforma completa para quem trabalha com semijoias.
          </motion.p>
          <motion.div initial="hidden" animate="visible" variants={fadeUp} custom={3} className="flex flex-col sm:flex-row gap-4 justify-center">
            <Button size="lg" className="bg-gradient-to-r from-purple-600 to-pink-600 hover:from-purple-700 hover:to-pink-700 text-white text-lg px-8 py-6 rounded-xl shadow-[0_0_30px_hsl(263,70%,50%,0.4)]"
              ...
              Experimente 3 Dias Grátis <ArrowRight className="w-5 h-5 ml-2" />
            </Button>
          ...
          <motion.div initial="hidden" animate="visible" variants={fadeUp} custom={4}
            ...
            <span className="flex items-center gap-1.5"><Check className="w-4 h-4 text-green-400" /> Suporte disponível</span>
          </motion.div>
        </div>
      ...
      <section id="screenshots" className="py-24 relative">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <motion.div initial="hidden" whileInView="visible" viewport={{ once: true }} variants={fadeUp} custom={0} className="text-center mb-16">
            ...
            <p className="text-white/50 max-w-2xl mx-auto">Acompanhe vendas, estoque, metas e mais — tudo num painel intuitivo.</p>
          </motion.div>
          <motion.div initial="hidden" whileInView="visible" viewport={{ once: true }} variants={fadeUp} custom={1}
            ...
            <img src={dashboardMockup} alt="Dashboard Nexsiles - Painel de gestão para semijoias" className="w-full" />
      ...
      <section id="features" className="py-24 bg-[hsl(224,30%,8%)]/60 backdrop-blur-sm">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <motion.div initial="hidden" whileInView="visible" viewport={{ once: true }} variants={fadeUp} custom={0} className="text-center mb-16">
            ...
            <p className="text-white/50 max-w-2xl mx-auto">Módulos integrados para gerir seu negócio de ponta a ponta.</p>
          </motion.div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            <motion.div initial="hidden" whileInView="visible" viewport={{ once: true }} variants={fadeUp} custom={0}>
              ...
              <h2 className="text-3xl sm:text-4xl font-bold mb-6">Venda online com auxílio de inteligência artificial</h2>
              <p className="text-white/50 mb-8 leading-relaxed">
                Sua loja virtual com checkout PIX, cartão e boleto. 
                O assistente IA auxilia no atendimento via WhatsApp, ajudando a responder dúvidas e encaminhar pedidos.
              </p>
              <div className="space-y-4">
                {['Chatbot IA no WhatsApp', 'Loja com checkout completo', 'Catálogo digital compartilhável', 'Recuperação de carrinho abandonado'].map((item) => (
            ...
            <motion.div initial="hidden" whileInView="visible" viewport={{ once: true }} variants={fadeUp} custom={1}
              ...
              <div className="relative w-72 sm:w-80">
                <img src={mobileMockup} alt="Loja Virtual Nexsiles - Visualização mobile" className="w-full rounded-3xl shadow-[0_0_60px_hsl(263,70%,50%,0.2)]" />
                <div className="absolute -top-4 -right-4 bg-gradient-to-r from-purple-600 to-pink-600 rounded-2xl px-4 py-2 shadow-lg">
                  <div className="flex items-center gap-2 text-sm font-semibold">
                    <Bot className="w-4 h-4" /> IA Integrada
                  </div>
                </div>
              </div>
            </motion.div>
      ...
      <section id="planos" className="py-24 bg-[hsl(224,30%,8%)]/60 backdrop-blur-sm">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <motion.div initial="hidden" whileInView="visible" viewport={{ once: true }} variants={fadeUp} custom={0} className="text-center mb-16">
            ...
            <p className="text-white/50 max-w-2xl mx-auto">Todos os planos incluem 3 dias de teste grátis. Cancele a qualquer momento.</p>
          </motion.div>
          ...
          <p className="text-center text-xs text-white/30 mt-8">
            * Após o período de teste, a assinatura será cobrada mensalmente. Você pode cancelar a qualquer momento antes do término do teste sem nenhum custo.
          </p>
        </div>
      </section>
      ...
      <section id="depoimentos" className="py-24">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <motion.div initial="hidden" whileInView="visible" viewport={{ once: true }} variants={fadeUp} custom={0} className="text-center mb-16">
            ...
            <p className="text-white/40 text-sm">Relatos reais de usuárias da plataforma. Resultados podem variar.</p>
          </motion.div>
      ...
      <section className="py-24 relative overflow-hidden">
        ...
        <div className="relative z-10 max-w-4xl mx-auto px-4 text-center">
          <motion.div initial="hidden" whileInView="visible" viewport={{ once: true }} variants={fadeUp} custom={0}>
            <h2 className="text-3xl sm:text-5xl font-extrabold mb-6">Pronta para organizar seu negócio?</h2>
            <p className="text-lg text-white/50 mb-10 max-w-2xl mx-auto">
              Experimente o Nexsiles gratuitamente por 3 dias e descubra como a plataforma pode ajudar na gestão do seu negócio de semijoias.
            </p>
      ...
      <footer className="border-t border-white/5 py-12 bg-[hsl(224,30%,8%)]/80 backdrop-blur-sm">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          {/* Links legais e identificação - Meta Ads compliance */}
          <div className="mt-8 pt-8 border-t border-white/5">
            ...
            <p className="text-xs text-white/20 text-center mt-4">
              Nexsiles é uma plataforma de gestão de semijoias. Os resultados podem variar de acordo com o uso e dedicação de cada usuário. 
              Este site não faz parte do Facebook/Meta Inc. Este site não é endossado pelo Facebook/Meta de nenhuma forma.
            </p>
          </div>
        </div>
      </footer>
